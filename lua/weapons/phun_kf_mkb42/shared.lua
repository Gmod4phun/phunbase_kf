...
SWEP.ViewModel = "models/gmod4phun/kf/v_mkb42.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_MKB42_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_MKB42_SELECT"}
	},
	reload = {
		{time = 3/30, sound = "PB_KF_MKB42_MAGLOCK"},
		{time = 11/30, sound = "PB_KF_MKB42_MAGOUT"},
		{time = 46/30, sound = "PB_KF_MKB42_MAGIN"},
		{time = 62/30, sound = "PB_KF_MKB42_BOLTBACK"}
	}
}
...
SWEP.FireSound = "PB_KF_MKB42_FIRE"
...
SWEP.KF_IconParams = {dist = 20.5, offsetPos = Vector(0,0,0), spin = false}
