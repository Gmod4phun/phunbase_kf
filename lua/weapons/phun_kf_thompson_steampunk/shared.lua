...
SWEP.PrintName = "Dr. T's Lead Delivery System"
...
SWEP.ViewModel = "models/gmod4phun/kf/v_thompson_steampunk.mdl"
...
SWEP.Sounds = {
	...
	reload = {
		{time = 10/30, sound = "PB_KF_TOMMYDRUM_MAG_A"},
		{time = 58/30, sound = "PB_KF_TOMMYDRUM_MAG_B"},
		{time = 88/30, sound = "PB_KF_TOMMYDRUM_BOLT_B"},
	}
}
...
SWEP.KF_IconParams = {dist = 21, offsetPos = Vector(0,0,0), spin = false}
