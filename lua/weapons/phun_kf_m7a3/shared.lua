...
SWEP.ViewModel = "models/gmod4phun/kf/v_medic_m7a3.mdl"
...
SWEP.Sounds = {
	...
	reload = {
		{time = 10/30, sound = "PB_KF_M7A3_MAGOUT"},
		{time = 34/30, sound = "PB_KF_M7A3_MAGIN"},
		{time = 42/30, sound = "PB_KF_M7A3_MAGHIT"},
		{time = 56/30, sound = "PB_KF_M7A3_BOLTBACK"},
		{time = 62/30, sound = "PB_KF_M7A3_BOLTFORWARD"}
	}
}
...
SWEP.FireSound = "PB_KF_M7A3_FIRE"
