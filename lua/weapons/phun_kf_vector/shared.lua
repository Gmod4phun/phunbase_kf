...
SWEP.ViewModel = "models/gmod4phun/kf/v_medic_kriss.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_VECTOR_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_VECTOR_SELECT"}
	},
	reload = {
		{time = 16/30, sound = "PB_KF_VECTOR_MAG_EJECT"},
		{time = 52/30, sound = "PB_KF_VECTOR_MAG_INSERT"},
		{time = 73/30, sound = "PB_KF_VECTOR_BOLTBACK"},
		{time = 83/30, sound = "PB_KF_VECTOR_BOLTFORWARD"}
	}
}
...
SWEP.FireSound = "PB_KF_VECTOR_FIRE"
