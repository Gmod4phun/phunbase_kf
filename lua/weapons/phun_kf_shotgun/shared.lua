...
SWEP.ViewModel = "models/gmod4phun/kf/v_shotgun.mdl"
...
SWEP.Sounds = {
	...
	reload_end_insert = {
		{time = 0.33, sound = "PB_KF_COMBATSHOTGUN_RELOAD_INSERT"},
		{time = 0.8, sound = "PB_KF_COMBATSHOTGUN_PUMP_1"},
		{time = 1.0, sound = "PB_KF_COMBATSHOTGUN_PUMP_2"},
		{time = 1.12, sound = "PB_KF_COMBATSHOTGUN_RELOAD_CLOTH"}
	},
	fire = {
		{time = 0.3, sound = "PB_KF_COMBATSHOTGUN_PUMP_1"},
		{time = 0.5, sound = "PB_KF_COMBATSHOTGUN_PUMP_2"}
	},
	fire_iron = {
		{time = 0.3, sound = "PB_KF_COMBATSHOTGUN_PUMP_1"},
		{time = 0.5, sound = "PB_KF_COMBATSHOTGUN_PUMP_2"}
...
-- SWEP.ShotgunReloadTime_End = 0.37
-- SWEP.ShotgunReloadTime_End_Empty = 1.33
