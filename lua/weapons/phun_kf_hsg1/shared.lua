...
SWEP.ViewModel = "models/gmod4phun/kf/v_shotgun_hsg1.mdl"
...
SWEP.Sounds = {
	fire = {
		{time = 7/30, sound = "PB_KF_HSG1_BOLTBACK"},
		{time = 15/30, sound = "PB_KF_HSG1_BOLTFORWARD"}
	},
	fire_iron = {
		{time = 7/30, sound = "PB_KF_HSG1_BOLTBACK"},
		{time = 15/30, sound = "PB_KF_HSG1_BOLTFORWARD"}
	...
	select = {
		{time = 0, sound = "PB_KF_HSG1_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_HSG1_SELECT"}
	},
	reload = {
		{time = 16/30, sound = "PB_KF_HSG1_MAGOUT"},
		{time = 54/30, sound = "PB_KF_HSG1_MAGIN"},
		{time = 75/30, sound = "PB_KF_HSG1_BOLTBACK"},
		{time = 84/30, sound = "PB_KF_HSG1_BOLTFORWARD"}
	}
}
...
SWEP.FireSound = "PB_KF_HSG1_FIRE"
...
SWEP.KF_IconParams = {dist = 16, offsetPos = Vector(0,0,0), spin = false}
