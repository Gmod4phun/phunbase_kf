...
SWEP.ViewModel = "models/gmod4phun/kf/v_ak47.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_AK47_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_AK47_SELECT"}
	},
	reload = {
		{time = 0/30, sound = "PB_KF_AK47_RELOAD_000"},
		{time = 11/30, sound = "PB_KF_AK47_RELOAD_011"},
		{time = 47/30, sound = "PB_KF_AK47_RELOAD_047"},
		{time = 71/30, sound = "PB_KF_AK47_RELOAD_071"}
	}
}

SWEP.DeployTime = 0.5
SWEP.IdleAfterDeployTime = 0.25
...
SWEP.FireSound = "PB_KF_AK47_FIRE"
...
SWEP.KF_IconParams = {dist = 17, offsetPos = Vector(0,0,0), spin = false}
