...
SWEP.ViewModel = "models/gmod4phun/kf/v_fnfal_acog.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_FNFAL_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_FNFAL_SELECT"}
	},
	reload = {
		{time = 20/30, sound = "PB_KF_FNFAL_MAG_EJECT"},
		{time = 60/30, sound = "PB_KF_FNFAL_MAG_INSERT"},
		{time = 77/30, sound = "PB_KF_FNFAL_BOLTBACK"},
		{time = 86/30, sound = "PB_KF_FNFAL_BOLTFORWARD"}
	}
}
...
SWEP.FireSound = "PB_KF_FNFAL_FIRE"
