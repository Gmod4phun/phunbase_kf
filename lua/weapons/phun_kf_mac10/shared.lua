...
SWEP.ViewModel = "models/gmod4phun/kf/v_mac10.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_MAC10_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_MAC10_SELECT"}
	},
	reload = {
		{time = 10/30, sound = "PB_KF_MAC10_MAG_EJECT"},
		{time = 48/30, sound = "PB_KF_MAC10_MAG_INSERT"},
		{time = 72/30, sound = "PB_KF_MAC10_PICKUP"},
	}
}
...
SWEP.FireSound = "PB_KF_MAC10_FIRE"
