...
SWEP.PrintName = "S.P. Long Musket"
...
SWEP.ViewModel = "models/gmod4phun/kf/v_sp_musket.mdl"
...
SWEP.Sounds = {
	fire = {
		{time = 11/30, sound = "PB_KF_MUSKET_BOLT_A"},
		{time = 14/30, sound = "PB_KF_MUSKET_BOLT_B"},
		{time = 22/30, sound = "PB_KF_MUSKET_BOLT_C"},
		{time = 25/30, sound = "PB_KF_MUSKET_BOLT_D"}
	},
	fire_iron = {
		{time = 11/30, sound = "PB_KF_MUSKET_BOLT_A"},
		{time = 14/30, sound = "PB_KF_MUSKET_BOLT_B"},
	...
	select = {
		{time = 0, sound = "PB_KF_MUSKET_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_MUSKET_SELECT"}
	},
	reload = {
		{time = 8/30, sound = "PB_KF_MUSKET_MAG_A"},
		{time = 14/30, sound = "PB_KF_MUSKET_MAG_B"},
		{time = 36/30, sound = "PB_KF_MUSKET_MAG_C"},
		{time = 42/30, sound = "PB_KF_MUSKET_MAG_D"},
		{time = 58/30, sound = "PB_KF_MUSKET_BOLT_A"},
		{time = 61/30, sound = "PB_KF_MUSKET_BOLT_B"},
		{time = 69/30, sound = "PB_KF_MUSKET_BOLT_C"},
		{time = 72/30, sound = "PB_KF_MUSKET_BOLT_D"}
	}
}
...
SWEP.FireSound = "PB_KF_MUSKET_FIRE"
