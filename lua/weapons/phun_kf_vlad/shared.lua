...
SWEP.ViewModel = "models/gmod4phun/kf/v_vlad_the_impaler.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_VLAD_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_VLAD_SELECT"}
	},
	reload = {
		{time = 12/30, sound = "PB_KF_VLAD_MAGOUT"},
		{time = 55/30, sound = "PB_KF_VLAD_MAGIN"},
	}
}
...
SWEP.FireSound = "PB_KF_VLAD_FIRE"
...
SWEP.KF_IconParams = {dist = 15, offsetPos = Vector(0,0,0), spin = false}
