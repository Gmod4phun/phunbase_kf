...
SWEP.ViewModel = "models/gmod4phun/kf/v_bullpup.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_BULLPUP_SELECT"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_BULLPUP_PICKUP"}
	},
	reload = {
		{time = 13/30, sound = "PB_KF_BULLPUP_RELOAD_013"},
		{time = 42/30, sound = "PB_KF_BULLPUP_RELOAD_042"}
	}
}
...
SWEP.FireSound = "PB_KF_BULLPUP_FIRE"
