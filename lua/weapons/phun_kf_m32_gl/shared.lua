...
SWEP.ViewModel = "models/gmod4phun/kf/v_m32_grenade_launcher.mdl"
...
SWEP.Sequences = {
	...
	reload_shell_end = "reload_end_insert",
...
SWEP.ShotgunReload_InsertOnEnd = true
SWEP.ShotgunReload_InsertOnEndEmpty = true

SWEP.ShotgunReloadTime_Start = 0.82
SWEP.ShotgunReloadTime_Start_Empty = 0.82
SWEP.ShotgunReloadTime_Insert = 1.6
SWEP.ShotgunReloadTime_End = 1.2
SWEP.ShotgunReloadTime_End_Empty = 1.2

SWEP.ShotgunReloadTime_InsertAmmoWait = 0.5
SWEP.ShotgunReloadTime_InsertOnEndAmmoWait = 0.45
...
SWEP.KF_IconParams = {dist = 19, offsetPos = Vector(0,0,0), spin = false}
