...
SWEP.PrintName = "Rising Storm Tommy gun"
...
SWEP.ViewModel = "models/gmod4phun/kf/v_thompson_drum.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_TOMMY_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_TOMMY_SELECT"}
	},
	reload = {
		{time = 10/30, sound = "PB_KF_TOMMY_MAGOUT"},
		{time = 56/30, sound = "PB_KF_TOMMY_MAGIN_1"},
		{time = 66/30, sound = "PB_KF_TOMMY_MAGIN_2"},
		{time = 88/30, sound = "PB_KF_TOMMYDRUM_BOLT_A"},
		{time = 89/30, sound = "PB_KF_TOMMY_MAGOUT"},
	}
}
...
SWEP.FireSound = "PB_KF_TOMMY_FIRE"
