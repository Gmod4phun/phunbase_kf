...
SWEP.ViewModel = "models/gmod4phun/kf/v_medic_mp5.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_MP5_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_MP5_SELECT"}
	},
	reload = {
		{time = 10/30, sound = "PB_KF_MP5_BOLTUP"},
		{time = 14/30, sound = "PB_KF_MP5_BOLTBACK"},
		{time = 56/30, sound = "PB_KF_MP5_MAGOUT"},
		{time = 78/30, sound = "PB_KF_MP5_MAGIN"},
		{time = 99/30, sound = "PB_KF_MP5_RESET"},
	}
}
