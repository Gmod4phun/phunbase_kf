...
SWEP.ViewModel = "models/gmod4phun/kf/v_thompson.mdl"
...
SWEP.Sounds = {
	...
	reload = {
		...
		{time = 49/30, sound = "PB_KF_TOMMY_MAGIN_1"},
		{time = 59/30, sound = "PB_KF_TOMMY_MAGIN_2"},
		{time = 84/30, sound = "PB_KF_TOMMYDRUM_BOLT_A"},
		{time = 85/30, sound = "PB_KF_TOMMY_MAGOUT"},
	}
}
