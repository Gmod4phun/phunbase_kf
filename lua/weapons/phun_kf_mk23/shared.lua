...
SWEP.ViewModel = "models/gmod4phun/kf/v_mk23.mdl"
...
SWEP.Sounds = {
	...
	reload = {
		...
		{time = 39/30, sound = "PB_KF_MK23_MAGIN"},
		{time = 59/30, sound = "PB_KF_MK23_BOLTFORWARD"}
	}
}
...
SWEP.KF_IconParams = {dist = 6, offsetPos = Vector(0,0,0), spin = false}
