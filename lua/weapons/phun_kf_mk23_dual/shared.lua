...
SWEP.ViewModel = "models/gmod4phun/kf/v_mk23_dual.mdl"
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_MK23_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_MK23_SELECT"}
	},
	reload = {
		{time = 5/30, sound = "PB_KF_MK23_MAGOUT"},
		{time = 8/30, sound = "PB_KF_MK23_MAGOUT"},
		{time = 38/30, sound = "PB_KF_MK23_MAGIN"},
		{time = 57/30, sound = "PB_KF_MK23_BOLTBACK"},
		{time = 69/30, sound = "PB_KF_MK23_BOLTFORWARD"},
		{time = 86/30, sound = "PB_KF_MK23_MAGIN"},
		{time = 112/30, sound = "PB_KF_MK23_BOLTHIT"},
		{time = 116/30, sound = "PB_KF_MK23_BOLTFORWARD"},
	}
}
...
SWEP.FireSound = "PB_KF_MK23_FIRE"
