...
SWEP.PrintName = "Multichambere ZED Thrower"
...
SWEP.ViewModel = "models/gmod4phun/kf/v_zed_thrower.mdl"
...
SWEP.SpreadVel = 1.25
SWEP.SpreadVel_Iron = 1.25
SWEP.SpreadAdd = 0.32
SWEP.SpreadAdd_Iron	= 0.32
...
SWEP.Sounds = {
	select = {
		{time = 0, sound = "PB_KF_ZEDTHROWER_PICKUP"}
	},
	putdown = {
		{time = 0, sound = "PB_KF_ZEDTHROWER_SELECT"}
	},
	reload = {
		{time = 10/30, sound = "PB_KF_ZEDTHROWER_RELOAD_A"},
		{time = 37/30, sound = "PB_KF_ZEDTHROWER_RELOAD_B"},
		{time = 54/30, sound = "PB_KF_ZEDTHROWER_RELOAD_C"},
		{time = 82/30, sound = "PB_KF_ZEDTHROWER_RELOAD_D"}
	}
}
...
SWEP.MuzzleEffect = {"weapon_muzzle_flash_smoke_small2", "muzzle_sparks_pistol"}
SWEP.DisableMuzzleLight = true

SWEP.FireSound = "PB_KF_ZEDTHROWER_FIRE"
...
SWEP.KF_IconParams = {dist = 20, offsetPos = Vector(0,0,0), spin = false}
